...
@section('content')
                                ...
                                <td class="actions" data-label="Actions">
                                    <button class="btn-view" title="View"
                                        onclick="openRequestModal(
                                            ...
                                            '{{ $request['date_allocate'] }}',
                                            '{{ $request['status'] }}',
                                            '{{ $request['milk_kinship'] }}'
                                        )">
    ...
    <script>
        function openRequestModal(reqId, donorId, volume, dateReq, dateAlloc, status, kinship) {
            ...
            // Format text safely
            document.getElementById("modal-status").innerText = status.charAt(0).toUpperCase() + status.slice(1);
            document.getElementById("modal-kinship").innerText = kinship.charAt(0).toUpperCase() + kinship.slice(1);
