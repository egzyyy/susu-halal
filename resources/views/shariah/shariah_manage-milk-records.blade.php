...
function openViewMilkModal(data) {
    ...
    statusEl.classList.add(`status-${base}`);       // e.g. status-not
    statusEl.classList.add(`status-${normalized}`); // e.g. status-not-yet-started (Grey)
